CREATE TABLE IF NOT EXISTS sri (id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ingested_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP, data jsonb NOT NULL);
...
CREATE UNIQUE INDEX idx_unique_versions ON sri((data->>'component'),(data->>'version'));
