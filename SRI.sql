CREATE TABLE IF NOT EXISTS sri (id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ingested_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP, data jsonb NOT NULL UNIQUE);
